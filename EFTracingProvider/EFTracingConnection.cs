...
namespace EFTracingProvider
{
    ...
    public class EFTracingConnection : DbConnectionWrapper
    {
        ...
        /* yahavgb$ I've added a modified constructor that allows you to specify the wrapped provider invariant name.
         * We have to set this property in order to create the extended DbContext without getting any exception. */

        /// <summary>
        /// Initializes a new instance of the EFTracingConnection class.
        /// </summary>
        /// <param name="wrappedConnection">The wrapped connection.</param>
        /// <param name="wrappedProviderInvariantName">The wrapped provider invariant name.</param>
        public EFTracingConnection(DbConnection wrappedConnection, string wrappedProviderInvariantName)
        {
            this.WrappedConnection = wrappedConnection;
            this.AddDefaultListenersFromConfiguration();
            this.WrappedProviderInvariantName = wrappedProviderInvariantName;
        }
